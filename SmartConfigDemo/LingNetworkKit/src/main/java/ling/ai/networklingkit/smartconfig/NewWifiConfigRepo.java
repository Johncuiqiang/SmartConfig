...
/**
 * Created by cuiqiang on 2017/10/30.
 */

public class NewWifiConfigRepo {
    ...
    public NewWifiConfigRepo(Context context){
     ...
     * @param ssid   wifi名称
     * @param pwd    wifi密码
     * @param capabilities   wifi的加密方式
     */
    public void connect(String ssid,String pwd,String capabilities){
        ...
        //尝试连接显示Wi-Fi
        try{
            connectWifi(ssid, pwd,false,capabilities);
        ...
        //尝试连接隐藏Wi-Fi
        try {
            connectWifi(ssid, pwd,true,capabilities);
            return;
        } catch (Exception ex) {
    ...
    public List<ScanResult> findWifiBySsid(String ssid, boolean refreshIfNotFound) {
    ...
    private void connectWifi(String ssid, String pwd,String capabilities,boolean isHidden) throws WifiConfigException {
        Log.d(TAG,"connectWifi2");
        WifiConfiguration config = generateNewConfig(ssid, "", isHidden);
        EncryptionType encryptionType  = EncryptionType.parse(capabilities);
    ...
    private void connectWifi(String ssid, String pwd,boolean isHidden,String capabilities) throws WifiConfigException {
...
//            for (ScanResult scanResult : wifiBySsid) {
                ...
                connectWifi(ssid, pwd, capabilities, isHidden);
                //return;
//            }
//        }
